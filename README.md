...
> It is a mobile application that allows users to study collections of flashcards.
> The app will allow users to create (,and delete) different categories of flashcards called "decks",
...
git clone https://github.com/reck1ess/MobileFlashcards.git
